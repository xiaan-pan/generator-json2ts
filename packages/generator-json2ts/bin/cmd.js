...
const { checkFileExists, readJsonFile, writeJsonFile, isValidIdentifier, isValidFilePath, updateConfig, checkRelatedVersions } = require('./utils');
...
program
    ...
    .option('-i, --input-path <inputpath>', 'The input path of the type file')
...
program
    ...
    .action(async () => {
        ...
        const result = writeJsonFile('./bin/config.json', jsonString);
